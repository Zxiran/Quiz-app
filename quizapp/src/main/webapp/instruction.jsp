...
<div class="container-fluid"  >
    <div class="modal-dialog" style="margin-top:0px;width:1200px;" >
        ...
        <div class="col-lg-6">
        <a href="/questions"><button type="button" id="prevBtn" onclick="nextPrev(1)" class="btn btn-green-moon  btn-fab" style="background-color:green;color:white;margin-left:350px;margin-top:20px;text-size:30px;">Start The Quiz</button></a>
        </div>
        </div>
