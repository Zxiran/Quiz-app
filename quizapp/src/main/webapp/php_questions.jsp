...
<form action="/php_calculation" method="post" id="php_quiz" name="quiz">
    ...
    <div class="modal-dialog" style="margin-top:130px;width:690px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label class="element-animation1 btn btn-lg btn-danger btn-block">
                <span class="btn-label"><i class="glyphicon glyphicon-chevron-right"></i></span> 
                <input onclick="this.className = ''"  type="radio" name="q2" value="1" id="btn1">${option1[2]}</label>
                
                <label class="element-animation2 btn btn-lg btn-danger btn-block">
                <span class="btn-label"><i class="glyphicon glyphicon-chevron-right"></i></span>
                <input onclick="this.className = ''"  type="radio" name="q2" value="2">${option2[2]}</label> 
                <label class="element-animation3 btn btn-lg btn-danger btn-block">
 
                <span class="btn-label">
                <i class="glyphicon glyphicon-chevron-right"></i></span> 
                <input onclick="this.className = ''" type="radio" name="q2" value="3">${option3[2]}</label> 
                <label class="element-animation4 btn btn-lg btn-danger btn-block">
                
                
                <span class="btn-label">
                <i class="glyphicon glyphicon-chevron-right"></i></span>
                <input onclick="this.className = ''" type="radio" name="q2" value="4">${option4[2]}</label> </div>
            </div>
        </div>                     
      </div>
</div>
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
    ...
    document.getElementById("php_quiz").submit();
    return false;
  }
